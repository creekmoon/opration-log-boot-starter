...
import cn.creekmoon.operationLog.hutool589.core.img.LabColor;
import cn.creekmoon.operationLog.hutool589.core.lang.ansi.Ansi8BitColor;
import cn.creekmoon.operationLog.hutool589.core.lang.ansi.AnsiBackground;
...
/**
 * 在 {@link Color AWT Colors} 的上下文中使用 {@link cn.creekmoon.operationLog.hutool589.core.lang.ansi.AnsiColor} 的实用程序
 * <p>来自Spring Boot</p>
 *
...
public final class AnsiColors {
    ...
    /**
     * @see cn.creekmoon.operationLog.hutool589.core.lang.ansi.AnsiColor#BRIGHT_WHITE
     */
    ...
    static {
        ...
        colorMap.put(new AnsiColorWrapper(cn.creekmoon.operationLog.hutool589.core.lang.ansi.AnsiColor.BLACK.getCode(), BitDepth.FOUR), new LabColor(0x000000));
        colorMap.put(new AnsiColorWrapper(cn.creekmoon.operationLog.hutool589.core.lang.ansi.AnsiColor.RED.getCode(), BitDepth.FOUR), new LabColor(0xAA0000));
        colorMap.put(new AnsiColorWrapper(cn.creekmoon.operationLog.hutool589.core.lang.ansi.AnsiColor.GREEN.getCode(), BitDepth.FOUR), new LabColor(0x00AA00));
        colorMap.put(new AnsiColorWrapper(cn.creekmoon.operationLog.hutool589.core.lang.ansi.AnsiColor.YELLOW.getCode(), BitDepth.FOUR), new LabColor(0xAA5500));
        colorMap.put(new AnsiColorWrapper(cn.creekmoon.operationLog.hutool589.core.lang.ansi.AnsiColor.BLUE.getCode(), BitDepth.FOUR), new LabColor(0x0000AA));
        colorMap.put(new AnsiColorWrapper(cn.creekmoon.operationLog.hutool589.core.lang.ansi.AnsiColor.MAGENTA.getCode(), BitDepth.FOUR), new LabColor(0xAA00AA));
        colorMap.put(new AnsiColorWrapper(cn.creekmoon.operationLog.hutool589.core.lang.ansi.AnsiColor.CYAN.getCode(), BitDepth.FOUR), new LabColor(0x00AAAA));
        colorMap.put(new AnsiColorWrapper(cn.creekmoon.operationLog.hutool589.core.lang.ansi.AnsiColor.WHITE.getCode(), BitDepth.FOUR), new LabColor(0xAAAAAA));
        colorMap.put(new AnsiColorWrapper(cn.creekmoon.operationLog.hutool589.core.lang.ansi.AnsiColor.BRIGHT_BLACK.getCode(), BitDepth.FOUR), new LabColor(0x555555));
        colorMap.put(new AnsiColorWrapper(cn.creekmoon.operationLog.hutool589.core.lang.ansi.AnsiColor.BRIGHT_RED.getCode(), BitDepth.FOUR), new LabColor(0xFF5555));
        colorMap.put(new AnsiColorWrapper(cn.creekmoon.operationLog.hutool589.core.lang.ansi.AnsiColor.BRIGHT_GREEN.getCode(), BitDepth.FOUR), new LabColor(0x55FF00));
        colorMap.put(new AnsiColorWrapper(cn.creekmoon.operationLog.hutool589.core.lang.ansi.AnsiColor.BRIGHT_YELLOW.getCode(), BitDepth.FOUR), new LabColor(0xFFFF55));
        colorMap.put(new AnsiColorWrapper(cn.creekmoon.operationLog.hutool589.core.lang.ansi.AnsiColor.BRIGHT_BLUE.getCode(), BitDepth.FOUR), new LabColor(0x5555FF));
        colorMap.put(new AnsiColorWrapper(cn.creekmoon.operationLog.hutool589.core.lang.ansi.AnsiColor.BRIGHT_MAGENTA.getCode(), BitDepth.FOUR), new LabColor(0xFF55FF));
        colorMap.put(new AnsiColorWrapper(cn.creekmoon.operationLog.hutool589.core.lang.ansi.AnsiColor.BRIGHT_CYAN.getCode(), BitDepth.FOUR), new LabColor(0x55FFFF));
