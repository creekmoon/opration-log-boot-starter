...
public class EqualsBuilder implements Builder<Boolean> {
     ...
     * </p>
     */
    private static final ThreadLocal<Set<Pair<cn.creekmoon.operationLog.hutool589.core.builder.IDKey, cn.creekmoon.operationLog.hutool589.core.builder.IDKey>>> REGISTRY = new ThreadLocal<>();
     ...
     * @since 3.0
     */
    static Set<Pair<cn.creekmoon.operationLog.hutool589.core.builder.IDKey, cn.creekmoon.operationLog.hutool589.core.builder.IDKey>> getRegistry() {
        return REGISTRY.get();
    }
     ...
     * @return the pair
     */
    static Pair<cn.creekmoon.operationLog.hutool589.core.builder.IDKey, cn.creekmoon.operationLog.hutool589.core.builder.IDKey> getRegisterPair(final Object lhs, final Object rhs) {
        final cn.creekmoon.operationLog.hutool589.core.builder.IDKey left = new cn.creekmoon.operationLog.hutool589.core.builder.IDKey(lhs);
        final cn.creekmoon.operationLog.hutool589.core.builder.IDKey right = new cn.creekmoon.operationLog.hutool589.core.builder.IDKey(rhs);
    ...
    static boolean isRegistered(final Object lhs, final Object rhs) {
        final Set<Pair<cn.creekmoon.operationLog.hutool589.core.builder.IDKey, cn.creekmoon.operationLog.hutool589.core.builder.IDKey>> registry = getRegistry();
        final Pair<cn.creekmoon.operationLog.hutool589.core.builder.IDKey, cn.creekmoon.operationLog.hutool589.core.builder.IDKey> pair = getRegisterPair(lhs, rhs);
        final Pair<cn.creekmoon.operationLog.hutool589.core.builder.IDKey, cn.creekmoon.operationLog.hutool589.core.builder.IDKey> swappedPair = new Pair<>(pair.getKey(), pair.getValue());
    ...
    static void unregister(final Object lhs, final Object rhs) {
        Set<Pair<cn.creekmoon.operationLog.hutool589.core.builder.IDKey, cn.creekmoon.operationLog.hutool589.core.builder.IDKey>> registry = getRegistry();
        if (registry != null) {
            final Pair<cn.creekmoon.operationLog.hutool589.core.builder.IDKey, cn.creekmoon.operationLog.hutool589.core.builder.IDKey> pair = getRegisterPair(lhs, rhs);
