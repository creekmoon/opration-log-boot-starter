 ...
 * @see cn.creekmoon.operationLog.hutool589.core.date.DatePattern 常用格式工具类
 * @since 5.3.9
 */
public class LocalDateTimeUtil {
    ...
    public static LocalDateTime parse(CharSequence text, String format) {
        ...
        if (StrUtil.isNotBlank(format)) {
            ...
            if (StrUtil.startWithIgnoreEquals(format, cn.creekmoon.operationLog.hutool589.core.date.DatePattern.PURE_DATETIME_PATTERN)) {
                final String fraction = StrUtil.removePrefix(format, cn.creekmoon.operationLog.hutool589.core.date.DatePattern.PURE_DATETIME_PATTERN);
                ...
                formatter = new DateTimeFormatterBuilder()
                        .appendPattern(cn.creekmoon.operationLog.hutool589.core.date.DatePattern.PURE_DATETIME_PATTERN)
    ...
    public static String formatNormal(LocalDateTime time) {
        return format(time, cn.creekmoon.operationLog.hutool589.core.date.DatePattern.NORM_DATETIME_FORMATTER);
    }
    ...
    public static String formatNormal(LocalDate date) {
        return format(date, cn.creekmoon.operationLog.hutool589.core.date.DatePattern.NORM_DATE_FORMATTER);
    }
     ...
     *
     * @param date      {@link LocalDate}
     * @param formatter 日期格式化器，预定义的格式见：{@link DateTimeFormatter}; 常量如： {@link cn.creekmoon.operationLog.hutool589.core.date.DatePattern#NORM_DATE_FORMATTER}, {@link cn.creekmoon.operationLog.hutool589.core.date.DatePattern#NORM_DATETIME_FORMATTER}
     * @return 格式化后的字符串
     * @since 5.3.10
     */
     ...
     *
     * @param date   {@link LocalDate}
     * @param format 日期格式，类似于yyyy-MM-dd, 常量如 {@link cn.creekmoon.operationLog.hutool589.core.date.DatePattern#NORM_DATE_PATTERN}, {@link DatePattern#NORM_DATETIME_PATTERN}
     * @return 格式化后的字符串
     * @since 5.3.10
     */
