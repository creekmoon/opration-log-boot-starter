...
public class PrimitiveArrayUtil {
    ...
    public static int[] unWrap(Integer... values) {
        ...
        for (int i = 0; i < length; i++) {
            array[i] = cn.creekmoon.operationLog.hutool589.core.util.ObjectUtil.defaultIfNull(values[i], 0);
        }
        return array;
    }
    ...
    public static long[] unWrap(Long... values) {
        ...
        final long[] array = new long[length];
        for (int i = 0; i < length; i++) {
            array[i] = cn.creekmoon.operationLog.hutool589.core.util.ObjectUtil.defaultIfNull(values[i], 0L);
        }
        return array;
    }
    ...
    public static char[] unWrap(Character... values) {
        ...
        for (int i = 0; i < length; i++) {
            array[i] = cn.creekmoon.operationLog.hutool589.core.util.ObjectUtil.defaultIfNull(values[i], Character.MIN_VALUE);
        }
        return array;
    }
    ...
    public static byte[] unWrap(Byte... values) {
        ...
        final byte[] array = new byte[length];
        for (int i = 0; i < length; i++) {
            array[i] = cn.creekmoon.operationLog.hutool589.core.util.ObjectUtil.defaultIfNull(values[i], (byte) 0);
        }
        return array;
    }
    ...
    public static short[] unWrap(Short... values) {
        ...
        final short[] array = new short[length];
        for (int i = 0; i < length; i++) {
            array[i] = cn.creekmoon.operationLog.hutool589.core.util.ObjectUtil.defaultIfNull(values[i], (short) 0);
        }
        return array;
    }
    ...
    public static float[] unWrap(Float... values) {
        ...
        final float[] array = new float[length];
        for (int i = 0; i < length; i++) {
            array[i] = cn.creekmoon.operationLog.hutool589.core.util.ObjectUtil.defaultIfNull(values[i], 0F);
        }
        return array;
    }
    ...
    public static double[] unWrap(Double... values) {
        ...
        final double[] array = new double[length];
        for (int i = 0; i < length; i++) {
            array[i] = cn.creekmoon.operationLog.hutool589.core.util.ObjectUtil.defaultIfNull(values[i], 0D);
        }
        return array;
    }
    ...
    public static int[] shuffle(int[] array) {
        return shuffle(array, cn.creekmoon.operationLog.hutool589.core.util.RandomUtil.getRandom());
    }
