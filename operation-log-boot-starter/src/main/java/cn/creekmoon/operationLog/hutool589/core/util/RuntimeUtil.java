...
import cn.creekmoon.operationLog.hutool589.core.lang.Pid;
...
public class RuntimeUtil {
    ...
    public static String execForStr(String... cmds) throws IORuntimeException {
        return execForStr(cn.creekmoon.operationLog.hutool589.core.util.CharsetUtil.systemCharset(), cmds);
    }
    ...
    public static List<String> execForLines(String... cmds) throws IORuntimeException {
        return execForLines(cn.creekmoon.operationLog.hutool589.core.util.CharsetUtil.systemCharset(), cmds);
    }
    ...
    public static List<String> getResultLines(Process process) {
        return getResultLines(process, cn.creekmoon.operationLog.hutool589.core.util.CharsetUtil.systemCharset());
    }
    ...
    public static String getResult(Process process) {
        return getResult(process, cn.creekmoon.operationLog.hutool589.core.util.CharsetUtil.systemCharset());
    }
    ...
    private static String[] handleCmds(String... cmds) {
        ...
        if (1 == cmds.length) {
            ...
            if (cn.creekmoon.operationLog.hutool589.core.util.StrUtil.isBlank(cmd)) {
    ...
    private static String[] cmdSplit(String cmd) {
        ...
        for (int i = 0; i < length; i++) {
            c = cmd.charAt(i);
            switch (c) {
                case cn.creekmoon.operationLog.hutool589.core.util.CharUtil.SINGLE_QUOTE:
                case cn.creekmoon.operationLog.hutool589.core.util.CharUtil.DOUBLE_QUOTES:
                    if (inWrap) {
                        if (c == stack.peek()) {
                            //结束包装
                            stack.pop();
