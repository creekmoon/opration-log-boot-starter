...
import cn.creekmoon.operationLog.hutool589.core.io.CharsetDetector;
...
public class CharsetUtil {
    ...
    public static Charset charset(String charsetName) throws UnsupportedCharsetException {
        return cn.creekmoon.operationLog.hutool589.core.util.StrUtil.isBlank(charsetName) ? Charset.defaultCharset() : Charset.forName(charsetName);
    }
