...
import cn.creekmoon.operationLog.hutool589.core.io.resource.FileObjectResource;
import cn.creekmoon.operationLog.hutool589.core.lang.ResourceClassLoader;
...
class JavaClassFileManager extends ForwardingJavaFileManager<JavaFileManager> {
    ...
    public JavaFileObject getJavaFileForOutput(final Location location, final String className, final Kind kind, final FileObject sibling) {
        final JavaFileObject javaFileObject = new cn.creekmoon.operationLog.hutool589.core.compiler.JavaClassFileObject(className);
