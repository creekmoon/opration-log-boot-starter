...
public class DesensitizedUtil {
    ...
    public static String chineseName(String fullName) {
        if (cn.creekmoon.operationLog.hutool589.core.util.StrUtil.isBlank(fullName)) {
            return cn.creekmoon.operationLog.hutool589.core.util.StrUtil.EMPTY;
        }
        return cn.creekmoon.operationLog.hutool589.core.util.StrUtil.hide(fullName, 1, fullName.length());
    }
    ...
    public static String idCardNum(String idCardNum, int front, int end) {
        //身份证不能为空
        if (cn.creekmoon.operationLog.hutool589.core.util.StrUtil.isBlank(idCardNum)) {
            return cn.creekmoon.operationLog.hutool589.core.util.StrUtil.EMPTY;
        }
        //需要截取的长度不能大于身份证号长度
        ...
        return cn.creekmoon.operationLog.hutool589.core.util.StrUtil.hide(idCardNum, front, idCardNum.length() - end);
    }
    ...
    public static String fixedPhone(String num) {
        if (cn.creekmoon.operationLog.hutool589.core.util.StrUtil.isBlank(num)) {
            return cn.creekmoon.operationLog.hutool589.core.util.StrUtil.EMPTY;
        }
        return cn.creekmoon.operationLog.hutool589.core.util.StrUtil.hide(num, 4, num.length() - 2);
    }
    ...
    public static String mobilePhone(String num) {
        ...
        return cn.creekmoon.operationLog.hutool589.core.util.StrUtil.hide(num, 3, num.length() - 4);
    }
    ...
    public static String address(String address, int sensitiveSize) {
        if (cn.creekmoon.operationLog.hutool589.core.util.StrUtil.isBlank(address)) {
            return cn.creekmoon.operationLog.hutool589.core.util.StrUtil.EMPTY;
        }
        int length = address.length();
        return cn.creekmoon.operationLog.hutool589.core.util.StrUtil.hide(address, length - sensitiveSize, length);
    }
    ...
    public static String email(String email) {
        if (cn.creekmoon.operationLog.hutool589.core.util.StrUtil.isBlank(email)) {
            return cn.creekmoon.operationLog.hutool589.core.util.StrUtil.EMPTY;
        }
        int index = cn.creekmoon.operationLog.hutool589.core.util.StrUtil.indexOf(email, '@');
        if (index <= 1) {
            return email;
        }
        return cn.creekmoon.operationLog.hutool589.core.util.StrUtil.hide(email, 1, index);
    }
    ...
    public static String password(String password) {
        if (cn.creekmoon.operationLog.hutool589.core.util.StrUtil.isBlank(password)) {
            return cn.creekmoon.operationLog.hutool589.core.util.StrUtil.EMPTY;
        }
        return cn.creekmoon.operationLog.hutool589.core.util.StrUtil.repeat('*', password.length());
    }
    ...
    public static String carLicense(String carLicense) {
        if (cn.creekmoon.operationLog.hutool589.core.util.StrUtil.isBlank(carLicense)) {
            return cn.creekmoon.operationLog.hutool589.core.util.StrUtil.EMPTY;
        }
        // 普通车牌
        if (carLicense.length() == 7) {
            carLicense = cn.creekmoon.operationLog.hutool589.core.util.StrUtil.hide(carLicense, 3, 6);
        } else if (carLicense.length() == 8) {
            // 新能源车牌
            carLicense = cn.creekmoon.operationLog.hutool589.core.util.StrUtil.hide(carLicense, 3, 7);
        }
        return carLicense;
    }
    ...
    public static String bankCard(String bankCardNo) {
        if (cn.creekmoon.operationLog.hutool589.core.util.StrUtil.isBlank(bankCardNo)) {
            return bankCardNo;
        }
        ...
        for (int i = 0; i < midLength; ++i) {
            if (i % 4 == 0) {
                buf.append(cn.creekmoon.operationLog.hutool589.core.util.CharUtil.SPACE);
            }
            buf.append('*');
        }
