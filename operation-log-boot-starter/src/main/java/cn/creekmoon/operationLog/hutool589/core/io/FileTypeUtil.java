...
public class FileTypeUtil {
    ...
    public static String getType(InputStream in, String filename) {
        ...
        if (null == typeName) {
            // 未成功识别类型，扩展名辅助识别
            typeName = cn.creekmoon.operationLog.hutool589.core.io.FileUtil.extName(filename);
        } else if ("xls".equals(typeName)) {
            // xls、doc、msi的头一样，使用扩展名辅助判断
            final String extName = cn.creekmoon.operationLog.hutool589.core.io.FileUtil.extName(filename);
