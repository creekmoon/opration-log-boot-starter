...
public class IdcardUtil {
    ...
    public static String convert15To18(String idCard) {
        ...
        if (cn.creekmoon.operationLog.hutool589.core.util.ReUtil.isMatch(PatternPool.NUMBERS, idCard)) {
            // 获取出生年月日
            ...
            idCard18 = cn.creekmoon.operationLog.hutool589.core.util.StrUtil.builder().append(idCard, 0, 6).append(sYear).append(idCard.substring(8));
            // 获取校验位
    ...
    public static String convert18To15(String idCard) {
        if (cn.creekmoon.operationLog.hutool589.core.util.StrUtil.isNotBlank(idCard) && IdcardUtil.isValidCard18(idCard)) {
    ...
    public static boolean isValidCard(String idCard) {
        if (cn.creekmoon.operationLog.hutool589.core.util.StrUtil.isBlank(idCard)) {
            return false;
        }
    ...
    public static boolean isValidCard18(String idcard, boolean ignoreCase) {
        ...
        if (cn.creekmoon.operationLog.hutool589.core.util.ReUtil.isMatch(PatternPool.NUMBERS, code17)) {
            // 获取校验位
    ...
    public static String getProvinceByIdCard(String idcard) {
        ...
        if (cn.creekmoon.operationLog.hutool589.core.util.StrUtil.isNotBlank(code)) {
     ...
     * @return 隐藏后的身份证号码
     * @see cn.creekmoon.operationLog.hutool589.core.util.StrUtil#hide(CharSequence, int, int)
     * @since 3.2.2
     */
    public static String hide(String idcard, int startInclude, int endExclude) {
        return cn.creekmoon.operationLog.hutool589.core.util.StrUtil.hide(idcard, startInclude, endExclude);
    }
