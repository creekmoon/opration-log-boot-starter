 ...
 * 进行后置处理。<br>
 * 默认情况下，将注册以下后置处理器以对{@link cn.creekmoon.operationLog.hutool589.core.annotation.Alias}与{@link Link}和其扩展注解提供支持：
 * <ul>
 ...
 * 返回的属性值将根据合成注解中对应原始注解属性上的{@link cn.creekmoon.operationLog.hutool589.core.annotation.Alias}与{@link Link}注解而有所变化。
 ...
 * @see cn.creekmoon.operationLog.hutool589.core.annotation.AnnotationUtil
...
public class GenericSynthesizedAggregateAnnotation
	...
	/**
	 * 根据指定的属性名与属性类型获取对应的属性值，若存在{@link cn.creekmoon.operationLog.hutool589.core.annotation.Alias}则获取{@link Alias#value()}指定的别名属性的值
