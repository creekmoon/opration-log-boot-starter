...
public class PrimitiveConverter extends AbstractConverter<Object> {
    ...
    protected static Object convert(Object value, Class<?> primitiveClass, Function<Object, String> toStringFunc) {
        if (byte.class == primitiveClass) {
            return ObjectUtil.defaultIfNull(cn.hutool.core.convert.impl.NumberConverter.convert(value, Byte.class, toStringFunc), 0);
        } else if (short.class == primitiveClass) {
            return ObjectUtil.defaultIfNull(cn.hutool.core.convert.impl.NumberConverter.convert(value, Short.class, toStringFunc), 0);
        } else if (int.class == primitiveClass) {
            return ObjectUtil.defaultIfNull(cn.hutool.core.convert.impl.NumberConverter.convert(value, Integer.class, toStringFunc), 0);
        } else if (long.class == primitiveClass) {
            return ObjectUtil.defaultIfNull(cn.hutool.core.convert.impl.NumberConverter.convert(value, Long.class, toStringFunc), 0);
        } else if (float.class == primitiveClass) {
            return ObjectUtil.defaultIfNull(cn.hutool.core.convert.impl.NumberConverter.convert(value, Float.class, toStringFunc), 0);
