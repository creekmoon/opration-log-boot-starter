...
public class DateBetween implements Serializable {
     ...
     * @return 时长差
     */
    public long between(cn.hutool.core.date.DateUnit unit) {
    ...
    public long betweenMonth(boolean isReset) {
        final Calendar beginCal = cn.hutool.core.date.DateUtil.calendar(begin);
        final Calendar endCal = cn.hutool.core.date.DateUtil.calendar(end);
     ...
     * @since 5.7.17
     */
    public String toString(cn.hutool.core.date.DateUnit unit, BetweenFormatter.Level level) {
