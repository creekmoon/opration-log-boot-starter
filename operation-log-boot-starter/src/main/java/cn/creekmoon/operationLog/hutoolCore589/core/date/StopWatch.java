...
public class StopWatch {
    ...
    public double getTotalTimeSeconds() {
        return cn.hutool.core.date.DateUtil.nanosToSeconds(this.totalTimeNanos);
    }
    ...
    public String shortSummary(TimeUnit unit) {
        ...
        return StrUtil.format("StopWatch '{}': running time = {} {}",
                this.id, getTotal(unit), cn.hutool.core.date.DateUtil.getShotName(unit));
    }
    ...
    public String prettyPrint(TimeUnit unit) {
        ...
        if (null == this.taskList) {
            ...
            sb.append(cn.hutool.core.date.DateUtil.getShotName(unit)).append("         %     Task name").append(FileUtil.getLineSeparator());
            sb.append("---------------------------------------------").append(FileUtil.getLineSeparator());
