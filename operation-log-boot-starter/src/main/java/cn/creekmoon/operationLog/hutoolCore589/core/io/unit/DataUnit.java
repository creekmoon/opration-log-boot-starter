...
public enum DataUnit {
     ...
     * Bytes, 后缀表示为： {@code B}.
     */
    BYTES("B", cn.hutool.core.io.unit.DataSize.ofBytes(1)),

    /**
     * Kilobytes, 后缀表示为： {@code KB}.
     */
    KILOBYTES("KB", cn.hutool.core.io.unit.DataSize.ofKilobytes(1)),

    /**
     * Megabytes, 后缀表示为： {@code MB}.
     */
    MEGABYTES("MB", cn.hutool.core.io.unit.DataSize.ofMegabytes(1)),

    /**
     * Gigabytes, 后缀表示为： {@code GB}.
     */
    GIGABYTES("GB", cn.hutool.core.io.unit.DataSize.ofGigabytes(1)),

    /**
     * Terabytes, 后缀表示为： {@code TB}.
     */
    TERABYTES("TB", cn.hutool.core.io.unit.DataSize.ofTerabytes(1));

    public static final String[] UNIT_NAMES = new String[]{"B", "KB", "MB", "GB", "TB", "PB", "EB"};

    private final String suffix;

    private final cn.hutool.core.io.unit.DataSize size;


    DataUnit(String suffix, cn.hutool.core.io.unit.DataSize size) {
        this.suffix = suffix;
        this.size = size;
    }
