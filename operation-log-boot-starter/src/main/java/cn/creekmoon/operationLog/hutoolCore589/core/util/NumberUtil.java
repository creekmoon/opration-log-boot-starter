...
public class NumberUtil {
    ...
    public static BigDecimal mul(Number... values) {
        if (cn.hutool.core.util.ArrayUtil.isEmpty(values) || cn.hutool.core.util.ArrayUtil.hasNull(values)) {
            return BigDecimal.ZERO;
        }
    ...
    public static BigDecimal div(Number v1, Number v2, int scale, RoundingMode roundingMode) {
        ...
        return div(cn.hutool.core.util.StrUtil.toStringOrNull(v1), cn.hutool.core.util.StrUtil.toStringOrNull(v2), scale, roundingMode);
    }
    ...
    public static boolean isInteger(String s) {
        if (cn.hutool.core.util.StrUtil.isBlank(s)) {
            return false;
        }
        try {
            Integer.parseInt(s);
    ...
    public static int[] generateRandomNumber(int begin, int end, int size) {
        // 种子你可以随意生成，但不能重复
        final int[] seed = cn.hutool.core.util.ArrayUtil.range(begin, end);
    ...
    public static BigInteger factorial(BigInteger start, BigInteger end) {
        ...
        if (start.compareTo(BigInteger.ZERO) < 0 || end.compareTo(BigInteger.ZERO) < 0) {
            throw new IllegalArgumentException(cn.hutool.core.util.StrUtil.format("Factorial start and end both must be > 0, but got start={}, end={}", start, end));
        }
    ...
    private static long factorialMultiplyAndCheck(long a, long b) {
        ...
        throw new IllegalArgumentException(cn.hutool.core.util.StrUtil.format("Overflow in multiplication: {} * {}", a, b));
    }
    ...
    public static long factorial(long n) {
        if (n < 0 || n > 20) {
            throw new IllegalArgumentException(cn.hutool.core.util.StrUtil.format("Factorial must have n >= 0 and n <= 20 for n!, but got n = {}", n));
        }
     ...
     * @return 是否相同
     * @see cn.hutool.core.util.CharUtil#equals(char, char, boolean)
     * @since 3.2.1
     */
     ...
     * @return 最小值
     * @see cn.hutool.core.util.ArrayUtil#min(Comparable[])
     * @since 4.0.7
     */
    public static <T extends Comparable<? super T>> T min(T[] numberArray) {
        return cn.hutool.core.util.ArrayUtil.min(numberArray);
    }
     ...
     * @param numberArray 数字数组
     * @return 最小值
     * @see cn.hutool.core.util.ArrayUtil#min(long...)
     * @since 4.0.7
     */
     ...
     * @param numberArray 数字数组
     * @return 最小值
     * @see cn.hutool.core.util.ArrayUtil#min(int...)
     * @since 4.0.7
     */
     ...
     * @param numberArray 数字数组
     * @return 最小值
     * @see cn.hutool.core.util.ArrayUtil#min(short...)
     * @since 4.0.7
     */
     ...
     * @param numberArray 数字数组
     * @return 最小值
     * @see cn.hutool.core.util.ArrayUtil#min(double...)
     * @since 4.0.7
     */
     ...
     * @param numberArray 数字数组
     * @return 最小值
     * @see cn.hutool.core.util.ArrayUtil#min(float...)
     * @since 4.0.7
     */
     ...
     * @param numberArray 数字数组
     * @return 最大值
     * @see cn.hutool.core.util.ArrayUtil#max(Comparable[])
     * @since 4.0.7
     */
    public static <T extends Comparable<? super T>> T max(T[] numberArray) {
        return cn.hutool.core.util.ArrayUtil.max(numberArray);
    }
     ...
     * @param numberArray 数字数组
     * @return 最大值
     * @see cn.hutool.core.util.ArrayUtil#max(long...)
     * @since 4.0.7
     */
     ...
     * @param numberArray 数字数组
     * @return 最大值
     * @see cn.hutool.core.util.ArrayUtil#max(int...)
     * @since 4.0.7
     */
     ...
     * @param numberArray 数字数组
     * @return 最大值
     * @see cn.hutool.core.util.ArrayUtil#max(short...)
     * @since 4.0.7
     */
     ...
     * @param numberArray 数字数组
     * @return 最大值
     * @see cn.hutool.core.util.ArrayUtil#max(double...)
     * @since 4.0.7
     */
     ...
     * @param numberArray 数字数组
     * @return 最大值
     * @see cn.hutool.core.util.ArrayUtil#max(float...)
     * @since 4.0.7
     */
    ...
    public static BigDecimal toBigDecimal(String numberStr) {
        if (cn.hutool.core.util.StrUtil.isBlank(numberStr)) {
            return BigDecimal.ZERO;
        }
    ...
    public static BigInteger toBigInteger(String number) {
        return cn.hutool.core.util.StrUtil.isBlank(number) ? BigInteger.ZERO : new BigInteger(number);
    }
    ...
    public static BigInteger newBigInteger(String str) {
        str = cn.hutool.core.util.StrUtil.trimToNull(str);
        if (null == str) {
            return null;
        }
    ...
    public static int parseInt(String number) throws NumberFormatException {
        if (cn.hutool.core.util.StrUtil.isBlank(number)) {
            return 0;
        }

        if (cn.hutool.core.util.StrUtil.containsIgnoreCase(number, "E")) {
            // 科学计数法忽略支持，科学计数法一般用于表示非常小和非常大的数字，这类数字转换为int后精度丢失，没有意义。
            throw new NumberFormatException(cn.hutool.core.util.StrUtil.format("Unsupported int format: [{}]", number));
        }

        if (cn.hutool.core.util.StrUtil.startWithIgnoreCase(number, "0x")) {
            // 0x04表示16进制数
