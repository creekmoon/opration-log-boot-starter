...
public class BetweenFormatter implements Serializable {
    ...
    public String format() {
        ...
        if (betweenMs > 0) {
            long day = betweenMs / cn.hutool.core.date.DateUnit.DAY.getMillis();
            long hour = betweenMs / cn.hutool.core.date.DateUnit.HOUR.getMillis() - day * 24;
            long minute = betweenMs / cn.hutool.core.date.DateUnit.MINUTE.getMillis() - day * 24 * 60 - hour * 60;
