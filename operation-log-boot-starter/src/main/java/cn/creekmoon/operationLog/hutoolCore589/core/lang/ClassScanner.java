...
public class ClassScanner implements Serializable {
     ...
     * 过滤器
     */
    private final cn.hutool.core.lang.Filter<Class<?>> classFilter;
    /**
     * 编码
     */
     ...
     * @since 5.7.5
     */
    public static Set<Class<?>> scanAllPackage(String packageName, cn.hutool.core.lang.Filter<Class<?>> classFilter) {
     ...
     * @return 类集合
     */
    public static Set<Class<?>> scanPackage(String packageName, cn.hutool.core.lang.Filter<Class<?>> classFilter) {
     ...
     */
    public ClassScanner(String packageName, cn.hutool.core.lang.Filter<Class<?>> classFilter) {
     ...
     * @param charset     编码
     */
    public ClassScanner(String packageName, cn.hutool.core.lang.Filter<Class<?>> classFilter, Charset charset) {
