...
public class DateModifier {
    ...
    public static Calendar modify(Calendar calendar, int dateField, ModifyType modifyType, boolean truncateMillisecond) {
        ...
        if (Calendar.AM_PM == dateField) {
            boolean isAM = cn.hutool.core.date.DateUtil.isAM(calendar);
            switch (modifyType) {
                case TRUNCATE:
    ...
    private static void modifyField(Calendar calendar, int field, ModifyType modifyType) {
        ...
        switch (modifyType) {
            case TRUNCATE:
                calendar.set(field, cn.hutool.core.date.DateUtil.getBeginValue(calendar, field));
                break;
            case CEILING:
                calendar.set(field, cn.hutool.core.date.DateUtil.getEndValue(calendar, field));
                break;
            case ROUND:
                int min = cn.hutool.core.date.DateUtil.getBeginValue(calendar, field);
