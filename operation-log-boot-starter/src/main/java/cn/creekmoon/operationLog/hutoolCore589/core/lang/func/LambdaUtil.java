...
public class LambdaUtil {
     ...
     * @since 5.8.0
     */
    public static <R> Class<R> getRealClass(cn.hutool.core.lang.func.Func0<?> func) {
     ...
     * @since 5.7.23
     */
    public static <R> SerializedLambda resolve(cn.hutool.core.lang.func.Func0<R> func) {
        return _resolve(func);
    }
     ...
     * @return 函数名称
     */
    public static <P> String getMethodName(cn.hutool.core.lang.func.Func1<P, ?> func) {
     ...
     * @since 5.7.23
     */
    public static <R> String getMethodName(cn.hutool.core.lang.func.Func0<R> func) {
        return resolve(func).getImplMethodName();
    }
     ...
     * @since 5.8.0
     */
    public static <P, R> Class<P> getRealClass(cn.hutool.core.lang.func.Func1<P, R> func) {
        final SerializedLambda lambda = resolve(func);
        checkLambdaTypeCanGetClass(lambda.getImplMethodKind());
