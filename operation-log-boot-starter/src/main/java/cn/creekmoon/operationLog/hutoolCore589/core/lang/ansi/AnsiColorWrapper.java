...
public class AnsiColorWrapper {
    ...
    /**
     * 转换为 {@link cn.hutool.core.lang.ansi.AnsiElement} 实例
     *
     * @param foreOrBack 区分前景还是背景
     * @return {@link cn.hutool.core.lang.ansi.AnsiElement} 实例
     */
    public AnsiElement toAnsiElement(ForeOrBack foreOrBack) {
        if (bitDepth == AnsiColors.BitDepth.FOUR) {
            if (foreOrBack == ForeOrBack.FORE) {
                for (cn.hutool.core.lang.ansi.AnsiColor item : AnsiColor.values()) {
            ...
            for (cn.hutool.core.lang.ansi.AnsiBackground item : AnsiBackground.values()) {
        ...
        if (foreOrBack == ForeOrBack.FORE) {
            return cn.hutool.core.lang.ansi.Ansi8BitColor.foreground(this.code);
        }
