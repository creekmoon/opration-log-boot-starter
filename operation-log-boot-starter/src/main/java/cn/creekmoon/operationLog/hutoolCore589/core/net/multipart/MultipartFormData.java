...
public class MultipartFormData {
     ...
     * 请求文件
     */
    private final ListValueMap<String, cn.hutool.core.net.multipart.UploadFile> requestFiles = new ListValueMap<>();
    /**
     * 上传选项
     */
     ...
     */
    public MultipartFormData(cn.hutool.core.net.multipart.UploadSetting uploadSetting) {
    ...
    public void parseRequestStream(InputStream inputStream, Charset charset) throws IOException {
        ...
        while (true) {
            ...
            if (header.isFile == true) {
                ...
                final cn.hutool.core.net.multipart.UploadFile newFile = new cn.hutool.core.net.multipart.UploadFile(header, setting);
     ...
     */
    public cn.hutool.core.net.multipart.UploadFile getFile(String paramName) {
        cn.hutool.core.net.multipart.UploadFile[] values = getFiles(paramName);
     ...
     * @return 上传的文件列表
     */
    public cn.hutool.core.net.multipart.UploadFile[] getFiles(String paramName) {
        final List<cn.hutool.core.net.multipart.UploadFile> fileList = getFileList(paramName);
        if (null != fileList) {
            return fileList.toArray(new cn.hutool.core.net.multipart.UploadFile[0]);
        }
        return null;
    }
     ...
     * @since 5.3.0
     */
    public List<cn.hutool.core.net.multipart.UploadFile> getFileList(String paramName) {
     ...
     * @return 文件映射
     */
    public Map<String, cn.hutool.core.net.multipart.UploadFile[]> getFileMap() {
        return Convert.toMap(String.class, cn.hutool.core.net.multipart.UploadFile[].class, getFileListValueMap());
    }
     ...
     * @return 文件映射
     */
    public ListValueMap<String, cn.hutool.core.net.multipart.UploadFile> getFileListValueMap() {
